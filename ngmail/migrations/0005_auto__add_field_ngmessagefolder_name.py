...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NGMessageFolder.name'
        db.add_column('ngmail_ngmessagefolder', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NGMessageFolder.name'
        db.delete_column('ngmail_ngmessagefolder', 'name')
